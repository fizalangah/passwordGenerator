...
export default function GeneratePassword() {
  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-screen bg-black-100 dark:bg-gray-900">
            ...
            <div className="space-y-2">
              ...
              <div className="flex items-center space-x-2">
                <Input
                  ...
                  className="flex-1"
                />
                <Button type="button" onClick={copyToClipboard} className="bg-black text-white hover:text-black hover:border-black">
                  Copy to Clipboard
                </Button>
              </div>
            </div>
